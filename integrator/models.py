...
class SyncedProduct(models.Model):
    ...
    last_hash = models.CharField(
        ...
        blank=True,
        default="",
        help_text="SHA256 hash of the last payload successfully sent to e-shop",
    )
    ...
    active = models.BooleanField(
        default=True,
        help_text="Product is currently present in at least one of the ERP or the e-shop",
    )
    payload = models.JSONField(
        null=True, blank=True, help_text="Last transformed payload obtained from ERP"
    )
